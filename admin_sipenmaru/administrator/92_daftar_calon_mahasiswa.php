...
<aside class="right-side">
    <section class="content-header">
        ...
        <table style="width:100%;">
			...
			<tr>
				<td><a href="92_cetak_ruang_ujian_keseluruhan.php" class="btn btn-primary">Cetak Keseluruhan Data </a></td> 
				<td><a href="92_cetak_ruang_ujian.php" class="btn btn-primary">Cetak Password </a></td> 
		...
		<table style="width:100%;" class="table table-bordered">	
			...
			<?php 
				...
				<tr>
					...
					<td>$a[pc]</td>
					<td>
						<a href='92_cetak_ruang_ujian.php?user_id=$a[username]' class='btn btn-danger btn-sm'>Cetak	</a>  
					</td>
				</tr>";
				$i++;
			}
