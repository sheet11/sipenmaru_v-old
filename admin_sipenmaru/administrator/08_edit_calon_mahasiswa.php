<?php 
    ...
    include "js/date.php";
    $query=mysqli_query($kon,"select * from tb_formulir2 where username='$_GET[username]'");
...
<aside class="right-side">
    <section class="content-header">
        <div class="container-fluid" style="margin:10px;"> 
            <form method="post" action="08_prosesedit_calon_mahasiswa.php" enctype="multipart/form-data">  
                <table width="100%" class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><select name='pilihan_prodi1' class='form-control' >";
                            <option value="<?php echo $a['pilihan_prodi1']; ?>"><?php echo $a['pilihan_prodi1']; ?></option>
