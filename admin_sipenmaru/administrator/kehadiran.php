...
<aside class="right-side">
    <section class="content-header">
        ...
        <table style="width:100%;" class="table table-bordered">    
            <tr class="info">
                <th>No.</th><th>ID </th><th>Password</th><th>Nama</th><th>Prodi</th><th>Tempat Ujian</th><th>Ruang Ujian</th><th>Asal Sekolah</th><th>Status</th><th>Status Kehadiran</th><th width="150">Aksi</th>
            </tr>
            <?php 
            ...
            echo"
                <tr>
                    ...
                    <td>
                       <a href='hadir1pilihan.php?username=$a[username]' class='btn btn-success btn-xs' >
                            Hadir
                        </a> 
                        <a href='tidakhadir1pilihan.php?username=$a[username]' class='btn btn-info btn-xs'>
                            Tidak Hadir
                        </a>
                    </td>
                </tr>";
