   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    <table border="1">  
      <?php 
          ...
          $query=mysqli_query($kon,"select * from tb_formulir5 where hari='1' and sesi='3' order by sesi asc, hari asc, pc asc");
        ...
        <tr>
            ...
            <td>:</td>
            <td style='font-size:20;text-transform:uppercase;'><b>$a[nama_lengkap]</b></td>              
        </tr>
        <tr>
