...
<aside class="right-side">
    <section class="content-header">
        <div class="container-fluid" style="margin:10px;">  
			<form method="post" action="02_prosesedit_calon_mahasiswa_lintasprovinsi1pilihan.php" enctype="multipart/form-data">	
				<table width="100%" class="table table-hover">
					...
					<tr>
						<td>Pilihan Prodi </td>
						<td>:</td>
						<td><input type="text" name="pilihan_prodi" value="<?php echo $a['pilihan_prodi']; ?>" class="form-control"></td>
					</tr>
