...
<div id="page-wrapper">
    <div class="container-fluid" style="margin:30px;">	
    	<table style="width:100%;">
			...
			<tr>
				<td><a href="33_cetak_ruang_ujian_keseluruhan.php" class="btn btn-primary">Cetak Keseluruhan Data </a></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
		...
		<table style="width:100%;" class="table table-bordered">	
			...
			<?php 
				if(isset($_POST['submit'])){
					$cariid = $_POST['cariid'];
					$cari = $_POST['cari'];
					$query=mysqli_query($kon,"select * tb_pendaftaran_2 where status_aktif='Sudah Mengisi' where $cariid = '$cari' 
																								   or $cariid = '0'");
																								   $i = $posisi+1;		
			...
			echo"
				<tr>
					...
					<td>$a[ruang_ujian]</td>
					<td>
						<a href='32_cetak_ruang_ujian.php?user_id=$a[user_id]'>
				...
				$i++;
					...
					$query=mysqli_query($kon,"select * from tb_pendaftaran_2 where status_aktif='Sudah Mengisi' and ruang_ujian='Auditorium Blok 1' order by user_id  desc LIMIT $posisi,$batas");
    ...
    $jmldata = mysqli_num_rows(mysqli_query($kon,"SELECT * FROM tb_pendaftaran_2 where status_aktif='Sudah Mengisi'"));
