    ...
    <section class="content-header">
        ...
        <table style="width:100%;" class="table table-bordered">    
            <tr class="info">
                ...
                <th>Jumlah</th>
                <th>Rerata</th>
                <th>Akademik</th><th>Tingkat</th><th>Tahun</th><th>Non Akademik</th><th>Tingkat</th><th>Tahun</th>
            </tr>
            <?php 
            ...
            echo"
                <tr>
                    ...
                    <td>$jumlah</td>
                    <td>$rerata</td>
                    <td>$a[keterangan_prestasi_akademik]</td>
                    <td>$a[tingkat_prestasi_akademik]</td>
                    <td>$a[tahun_prestasi_akademik]</td>
                    <td>$a[keterangan_prestasi_nonakademik]</td>
                    <td>$a[tingkat_prestasi_nonakademik]</td>
                    <td>$a[tahun_prestasi_nonakademik]</td>
                </tr>";
                $i++;
            }
                }
