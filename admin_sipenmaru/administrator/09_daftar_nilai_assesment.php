        ...
        <table style="width:100%;" class="table table-bordered table-responsive">    
            ...
            <?php 
                ...
                while($a=mysqli_fetch_array($query)){
                    $satu   = mysqli_fetch_array(mysqli_query($kon,"select * from tb_rpl where username='$a[username]' AND semester = '1'"));
                    $dua    = mysqli_fetch_array(mysqli_query($kon,"select * from tb_rpl where username='$a[username]' AND semester = '2'"));
                    $tiga   = mysqli_fetch_array(mysqli_query($kon,"select * from tb_rpl where username='$a[username]' AND semester = '3'"));
                    $empat  = mysqli_fetch_array(mysqli_query($kon,"select * from tb_rpl where username='$a[username]' AND semester = '4'"));
                    $lima   = mysqli_fetch_array(mysqli_query($kon,"select * from tb_rpl where username='$a[username]' AND semester = '5'"));
                    $enam   = mysqli_fetch_array(mysqli_query($kon,"select * from tb_rpl where username='$a[username]' AND semester = '6'"));
            ...
            echo"
                <tr>
                    ...
                    //prestasi
                    $pr=mysqli_fetch_array(mysqli_query($kon,"select * from tb_rpl where username='$a[username]'"));
                    if($pr['tingkat']==1)
                    {
