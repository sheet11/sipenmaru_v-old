...
<aside class="right-side">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">                    
                        <td width="25%">
                            <select name="cariid" class="form-control">
                                ...
                                <option value="tempat_kuliah">Tempat Kuliah</option>
        ...
        <table style="width:100%;" class="table table-bordered">    
            ...
            <?php 
                ...
                if(isset($_POST['submit'])){
                    $cariid = $_POST['cariid'];
                    $cari = $_POST['cari'];
                    $query=mysqli_query($kon,"select * from tb_formulir1 where status='Sudah Membayar' and periode=2 and $cariid = '$cari' or $cariid = '0' "); 
                    $i = $posisi+1;      
            ...
            echo"
                ...
                elseif(!empty($_GET['username'])){
                    $query=mysqli_query($kon,"select * from tb_formulir1 where status='Sudah Membayar' and periode=2 and username='$_GET[username]'"); 
                    $i = $posisi+1;      
                while($a=mysqli_fetch_array($query)){
            echo"
                <tr>    
                ...
                $i++;
                    ...
                    $query=mysqli_query($kon,"select * from tb_formulir1 where status='Sudah Membayar' and periode =2 order by username asc  LIMIT $posisi,$batas");
    ...
    $jmldata = mysqli_num_rows(mysqli_query($kon,"SELECT * FROM tb_formulir1 where status='Sudah Membayar' and periode =2"));
