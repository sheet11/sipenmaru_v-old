    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xs-7 col-md-7 col-sm-6 col-lg-7">
            ...
            <a href="format import kelulusan 1 pilihan.xlsx" class="btn btn-primary btn-sm"><i class="fa da-download"></i> Download Format</a>
        </div>
  ...
  foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
  {
   ...
   for($row=2; $row<=$highestRow; $row++)
   {
    ...
    if(!empty($username)) // if none of the data are empty
    {
      ...
      {
        mysqli_query($kon,"update tb_formulir5 set status_pmdp='$status_pmdp', prodi_lulus='$prodi_lulus' where username='$username'");  
        ?>
        <div class="alert alert-success">Status Jalur Mandiri berhasil diubah untuk 
      ...
      {
        ?>
        <div class="alert alert-danger">Status Jalur Mandiri gagal diubah untuk 
          username : <?php echo $username.' 
          Nama : '.$nama.' 
