...
<aside class="right-side">
    <section class="content-header">
        ...
        <table style="width:100%;" class="table table-bordered">    
            <tr class="info">
                <th>No.</th><th>ID </th><th>Password</th><th>Nama</th><th>Prodi</th><th>Asal Sekolah</th><th>Status</th><th>Status Kehadiran</th><th>Status Kelulusan</th><th width="150">Aksi</th>
            </tr>
            <?php 
            ...
            echo"
                <tr>
                    ...
                    <td>
                       <a href='lulus_PMDP.php?username=$a[username]' class='btn btn-success btn-xs' >
                            Lulus
                        </a> 
                        <a href='tidaklulus_PMDP.php?username=$a[username]' class='btn btn-info btn-xs'>
                            Tidak Lulus
                        </a>
                    </td>
                </tr>";
