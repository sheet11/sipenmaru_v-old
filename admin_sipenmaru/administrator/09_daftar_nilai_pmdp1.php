...
<aside class="right-side">
    <section class="content-header">
        ...
        <table style="width:100%;">
            <tr class="info">
            <td align="left" colspan="6"><h4><b>Daftar Calon Mahasiswa Baru Jalur PMDP </b></h4></td>   
            ...
            <tr>
                <td>
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $cari = $_POST['cari'];
                    ?>
                        <a class="btn btn-info" href="09_cetak_excel_nilai_calon_mahasiswa_pmdp.php?cariid=<?php echo $cariid; ?>&cari=<?php echo $cari; ?>">Cetak Excel</a>
                    <?php
                    }
                    elseif(!empty($_GET['username']))
                    {
                    ?>
                        <a class="btn btn-info" href="09_cetak_excel_nilai_calon_mahasiswa_pmdp.php?username=<?php echo $_GET['username']; ?>">Cetak Excel</a>
                    <?php
                    }
                    else
                    {
                    ?>
                        <a class="btn btn-success" href="09_cetak_excel_nilai_calon_mahasiswa_pmdp.php">Cetak Excel</a>
                    <?php
                    }
                    ?>
                </td>
