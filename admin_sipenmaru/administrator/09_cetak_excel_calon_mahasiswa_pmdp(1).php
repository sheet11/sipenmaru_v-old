...
if(!empty($_GET['username']) AND empty($_GET['cariid']))
{
	...
	$excel->setActiveSheetIndex(0)->setCellValue('D3', "Jalur");
	$excel->setActiveSheetIndex(0)->setCellValue('E3', "Prodi");
	$excel->setActiveSheetIndex(0)->setCellValue('F3', "Alamat");
	$excel->setActiveSheetIndex(0)->setCellValue('G3', "Jenis Kelamin");
	...
	$excel->setActiveSheetIndex(0)->setCellValue('K3', "Tanggal lahir");
	$excel->setActiveSheetIndex(0)->setCellValue('L3', "Golongan Darah");
	$excel->setActiveSheetIndex(0)->setCellValue('M3', "NIK");
	$excel->setActiveSheetIndex(0)->setCellValue('N3', "Nama Orang Tua");
	$excel->setActiveSheetIndex(0)->setCellValue('O3', "Pekerjaan Orang Tua");
	$excel->setActiveSheetIndex(0)->setCellValue('P3', "Tempat Ujian");
	$excel->setActiveSheetIndex(0)->setCellValue('Q3', "Ruang Ujian");
	$excel->setActiveSheetIndex(0)->setCellValue('R3', "Nama Sekolah");
	$excel->setActiveSheetIndex(0)->setCellValue('S3', "Asal Sekolah");
	$excel->setActiveSheetIndex(0)->setCellValue('T3', "Keterangan Sekolah");
	$excel->setActiveSheetIndex(0)->setCellValue('U3', "Daerah Asal Sekolah");
	$excel->setActiveSheetIndex(0)->setCellValue('V3', "Jumlah Penghasilan");
	$excel->setActiveSheetIndex(0)->setCellValue('W3', "Kartu BPJS");
	$excel->setActiveSheetIndex(0)->setCellValue('X3', "I");
	$excel->setActiveSheetIndex(0)->setCellValue('Y3', "II");
	$excel->setActiveSheetIndex(0)->setCellValue('Z3', "III");
	$excel->setActiveSheetIndex(0)->setCellValue('AA3', "IV");
	$excel->setActiveSheetIndex(0)->setCellValue('AB3', "V");
	$excel->setActiveSheetIndex(0)->setCellValue('AC3', "Jumlah");
	$excel->setActiveSheetIndex(0)->setCellValue('AD3', "Rerata");
	$excel->setActiveSheetIndex(0)->setCellValue('AE3', "Bobot Rapor 20%");
	$excel->setActiveSheetIndex(0)->setCellValue('AF3', "Bobot Matematika 15%");
	$excel->setActiveSheetIndex(0)->setCellValue('AG3', "Bobot B.Indonesia 10%");
	$excel->setActiveSheetIndex(0)->setCellValue('AH3', "Bobot B.Inggris 15%");
	$excel->setActiveSheetIndex(0)->setCellValue('AI3', "Bobot Akreditasi 10%");
	$excel->setActiveSheetIndex(0)->setCellValue('AJ3', "Bobot Daerah 10%");
	$excel->setActiveSheetIndex(0)->setCellValue('AK3', "Bobot Prestasi 20%");
	$excel->setActiveSheetIndex(0)->setCellValue('AL3', "Total Nilai");
	...
	while($a=mysqli_fetch_array($query)){
		...
		$excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $a['level']);
		$excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $a['pilihan_prodi']);
		$excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $a['alamat']);
		$excel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, $a['jenis_kelamin']);
		$excel->setActiveSheetIndex(0)->setCellValue('H'.$numrow, $a['agama']);
		$excel->setActiveSheetIndex(0)->setCellValueExplicit('I'.$numrow, $a['no_hp'], PHPExcel_Cell_DataType::TYPE_STRING);
		$excel->setActiveSheetIndex(0)->setCellValue('J'.$numrow, $a['tempat_lahir']);
		$excel->setActiveSheetIndex(0)->setCellValue('K'.$numrow, $a['tanggal_lahir']);
		$excel->setActiveSheetIndex(0)->setCellValue('L'.$numrow, $a['golongan_darah']);
		$excel->setActiveSheetIndex(0)->setCellValueExplicit('M'.$numrow, $a['nik'],PHPExcel_Cell_DataType::TYPE_STRING);
		$excel->setActiveSheetIndex(0)->setCellValue('N'.$numrow, $a['nama_orang_tua']);
		$excel->setActiveSheetIndex(0)->setCellValue('O'.$numrow, $a['pekerjaan_orang_tua']);
		$excel->setActiveSheetIndex(0)->setCellValue('P'.$numrow, $a['tempat_ujian']);
		$excel->setActiveSheetIndex(0)->setCellValue('Q'.$numrow, $a['ruang_ujian']);
		$excel->setActiveSheetIndex(0)->setCellValue('R'.$numrow, $a['nama_sekolah']);
		$excel->setActiveSheetIndex(0)->setCellValue('S'.$numrow, $a['asal_sekolah']);
		$excel->setActiveSheetIndex(0)->setCellValue('T'.$numrow, $a['keterangan_sekolah']);
		$excel->setActiveSheetIndex(0)->setCellValue('U'.$numrow, $a['daerah_asal']);
		$excel->setActiveSheetIndex(0)->setCellValue('V'.$numrow, $a['penghasilan_orang_tua']);
		$excel->setActiveSheetIndex(0)->setCellValue('W'.$numrow, $a['kartu_bpjs']);
		$excel->setActiveSheetIndex(0)->setCellValue('X'.$numrow, $totalrata1);
		$excel->setActiveSheetIndex(0)->setCellValue('Y'.$numrow, $totalrata2);
		$excel->setActiveSheetIndex(0)->setCellValue('Z'.$numrow, $totalrata3);
		$excel->setActiveSheetIndex(0)->setCellValue('AA'.$numrow, $totalrata4);
		$excel->setActiveSheetIndex(0)->setCellValue('AB'.$numrow, $totalrata5);
		$excel->setActiveSheetIndex(0)->setCellValue('AC'.$numrow, $jumlah);
		$excel->setActiveSheetIndex(0)->setCellValue('AD'.$numrow, $rerata);
		$excel->setActiveSheetIndex(0)->setCellValue('AE'.$numrow, $reratabobot);
		$excel->setActiveSheetIndex(0)->setCellValue('AF'.$numrow, $ratamatika);
		$excel->setActiveSheetIndex(0)->setCellValue('AG'.$numrow, $rataindo);
		$excel->setActiveSheetIndex(0)->setCellValue('AH'.$numrow, $rataing);
		$excel->setActiveSheetIndex(0)->setCellValue('AI'.$numrow, $nakr);
		$excel->setActiveSheetIndex(0)->setCellValue('AJ'.$numrow, $ndaerah);
		$excel->setActiveSheetIndex(0)->setCellValue('AK'.$numrow, $nprestasi);
		$excel->setActiveSheetIndex(0)->setCellValue('AL'.$numrow, $totalnilai);
	...
	$excel->getActiveSheet()->getColumnDimension('AF')->setWidth(10);
...
elseif(empty($_GET['username']) AND empty($_GET['cariid']))
{
	...
	header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
	header('Content-Disposition: attachment; filename="Daftar Calon Mahasiswa PMDP.xlsx"');
	header('Cache-Control: max-age=0');
	$write = PHPExcel_IOFactory::createWriter($excel, 'Excel2007');
	$write->save('php://output');
}
