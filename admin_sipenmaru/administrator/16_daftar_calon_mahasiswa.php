...
<div id="page-wrapper">
		...
		<table style="width:100%;" class="table table-bordered">	
			...
			<?php 
				if(isset($_POST['submit'])){
					$cariid = $_POST['cariid'];
					$cari = $_POST['cari'];
					$query=mysqli_query($kon,"select * tb_pendaftaran_1  where $cariid = '$cari' 
																								   or $cariid = '0'");
																								   $i = $posisi+1;		
			...
			echo"
				...
				$i++;
					...
					$query=mysqli_query($kon,"select * from tb_pendaftaran_1 where status_pembayaran='Belum Membayar' order by user_id  desc LIMIT $posisi,$batas");
    ...
    $jmldata = mysqli_num_rows(mysqli_query($kon,"SELECT * FROM tb_pendaftaran_1 "));
