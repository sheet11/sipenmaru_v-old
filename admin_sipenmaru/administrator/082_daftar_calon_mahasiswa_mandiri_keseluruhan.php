...
<aside class="right-side">
    <section class="content-header">
        ...
        <table style="width:100%;">
            <tr class="info">
            <td align="left" colspan="6"><h4><b>Daftar Calon Mahasiswa Baru Jalur Mandir 1 Pilihan </b></h4></td>   
            ...
            <tr>
                <td>
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $cari = $_POST['cari'];
                    ?>
                        <a class="btn btn-info" href="082_cetak_excel_calon_mahasiswa_mandiri.php?cariid=<?php echo $cariid; ?>&cari=<?php echo $cari; ?>">Cetak Excel</a>
                    <?php
                    }
                    elseif(!empty($_GET['username']))
                    {
                    ?>
                        <a class="btn btn-info" href="082_cetak_excel_calon_mahasiswa_mandiri.php?username=<?php echo $_GET['username']; ?>">Cetak Excel</a>
                    <?php
                    }
                    else
                    {
                    ?>
                        <a class="btn btn-success" href="082_cetak_excel_calon_mahasiswa_mandiri.php">Cetak Excel</a>
                    <?php
                    }
                    ?>
                </td>
