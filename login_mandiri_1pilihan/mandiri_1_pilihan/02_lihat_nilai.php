	...
	<div id="page-inner">
        ...
        <table style="width:100%;">
			<tr>
				...
				<td>&nbsp;</td>
				<?php }else{ ?>
				<td><a href='02_input_nilai.php' class='btn btn-primary'>Isi Form</a></td>
				<?php } ?>
			</tr>
		</table> 
					...
					while($a=mysqli_fetch_array($query))
					{
						...
						<tr>
							...
							<td>";
									if($cek){
									echo "
											<a href='02_edit_nilai.php?username=$a[username]' class='btn btn-danger'><b>Edit</b></a>";
										}else{
											echo "Silahkan Isi Form Terlebihdahulu";
										}
						if($cek){
									echo "
											<a href='02_cetak_nilai.php?username=$a[username]' class='btn btn-danger'><b>Cetak</b></a>";
										}else{
											echo "Silahkan Isi Form Terlebihdahulu";
										}
							echo "</td>
