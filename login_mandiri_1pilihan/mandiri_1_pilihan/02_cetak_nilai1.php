...
<?php
	...
	$query=mysqli_query($kon,"select * from tb_nilai, tb_formulir4 where tb_nilai.username=tb_formulir4.username AND tb_nilai.username='$_SESSION[username]' ");
	...
	<body>
		...
		<table  class="table table-bordered">
			<tr>
				...
				<td rowspan="3" align="center">MATA PELAJARAN</td>
				<td colspan="10" align="center">Semester</td>
			</tr>
			<tr>
			...
			<tr>
				<?php
					...
					$jumlahpeng5 = $totalpeng5/$countpeng5;
					...
					$jumlahprak5 = $totalprak5/$countprak5;
